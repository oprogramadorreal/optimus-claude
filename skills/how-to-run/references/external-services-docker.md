...
Render **one** of these templates per service, chosen by the heuristics. Keep all service subsections under the same External Services container. The template snippets below show the multi-repo H3 form (External Services as `## External Services`); use H4 in single-project / monorepo (External Services as `### External Services`).
