...
|---------|-----------------------|------------------------|-------|
| SQL Server | `mcr.microsoft.com/mssql/server:2022-latest` | [MS Learn — SQL Server Linux container quickstart](https://learn.microsoft.com/en-us/sql/linux/install-upgrade/quickstart-install-docker?view=sql-server-ver17) | `ACCEPT_EULA=Y` + `MSSQL_SA_PASSWORD` (policy: ≥8 chars, at least three of uppercase/lowercase/digit/symbol). Port 1433. Volume `/var/opt/mssql`. Vendor-supported on Linux x86-64; ARM emulation is unsupported. |
