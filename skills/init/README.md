...
| `references/agents/` | Agent prompt files for codebase-detection and documentation-audit subagents |
...
- **Agents**: `agents/` at repo root (code-simplifier, test-guardian — plugin-level, shared across skills)
