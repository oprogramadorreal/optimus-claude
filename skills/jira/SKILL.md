...
Route by issue type and the Step 5 Scope Assessment (fall back to acceptance-criteria count when inconclusive). The recommended skill gathers its own context, so suggest a fresh conversation for it.
