...
| `references/body-file-tempfile.md` | Portable mktemp + quoted-heredoc pattern for `gh`/`glab` body-file flows (used by this skill, `/optimus:tdd`, and `/optimus:code-review`) |
