...
Do NOT modify any files. Do NOT flag guideline violations (Guideline Compliance agent), testability barriers (Testability Analyzer), or code simplification (Code Simplifier). Do NOT flag duplication that exists for good reason (e.g., deliberate copy to avoid coupling between modules).
Maximum 8 findings.
