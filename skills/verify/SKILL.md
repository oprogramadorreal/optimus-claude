...
Read the agent prompt files from `$CLAUDE_PLUGIN_ROOT/skills/verify/references/agents/` for individual agent prompts. Read `$CLAUDE_PLUGIN_ROOT/skills/verify/references/agents/shared-constraints.md` for the shared constraints and quality bar that apply to all agents.
