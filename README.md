...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.68.0-blue" alt="Version">
...
| [`/optimus:how-to-run`](skills/how-to-run/README.md) | Generates a `HOW-TO-RUN.md` that teaches a new developer how to set up their environment and run the project locally — works for web, C/C++, native mobile, JVM/Android, game engines, embedded/firmware, and backend stacks. For external services not covered by docker-compose, classifies each as Docker-preferred, Shared-cloud primary, or Local install only and emits a vendor-cited `docker run` snippet. Writes only `HOW-TO-RUN.md`; reports outdated info found elsewhere. |
