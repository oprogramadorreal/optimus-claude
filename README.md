...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.79.0-blue" alt="Version">
...
| [`/optimus:handoff`](skills/handoff/README.md) | Compacts the current conversation into a single self-contained, tool-agnostic handoff document under `docs/handoffs/` so any fresh agent can resume the work by reading only that file. References committed artifacts by path/URL, inlines anything unpushed, redacts secrets/PII, and suggests the next optimus skills. Re-run to enhance or overwrite the shared doc. |
