...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.59.5-blue" alt="Version">
...
| [`/optimus:how-to-run`](skills/how-to-run/README.md) | Generates a `HOW-TO-RUN.md` that teaches a new developer how to set up their environment and run the project locally — works for web, C++, mobile, game engines, embedded, and backend stacks. Writes only `HOW-TO-RUN.md`; reports outdated info found elsewhere. |
